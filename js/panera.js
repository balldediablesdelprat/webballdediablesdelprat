const comerciosData = [
    ...
    { id: 39, name: "PadelCrack", category: "moda", lat: 41.3228996, lng: 2.0972452, color: "#3498db", description: "Carrer de Lleida, 108, El Prat de Llobregat", address: "Carrer de Lleida, 108, El Prat de Llobregat" },
    { id: 40, name: "El Ninot", category: "cultura", lat: 41.3271689, lng: 2.1001124, color: "#f39c12", description: "Carretera de la Marina, 25, El Prat de Llobregat", address: "Carretera de la Marina, 25, El Prat de Llobregat" },
    { id: 41, name: "Natur Prat", category: "llar", lat: 41.3241008, lng: 2.0894617, color: "#2ecc71", description: "Av. de la Verge de Montserrat, 200, El Prat de Llobregat", address: "Av. de la Verge de Montserrat, 200, El Prat de Llobregat" },
    { id: 42, name: "Atleet", category: "moda", lat: 41.3237653, lng: 2.1026854, color: "#3498db", description: "Carretera de la Marina, 77, El Prat de Llobregat", address: "Carretera de la Marina, 77, El Prat de Llobregat" },
    { id: 43, name: "Ferreteria JM", category: "llar", lat: 41.3243881, lng: 2.1011777, color: "#2ecc71", description: "Carrer de Lleida, 144, El Prat de Llobregat", address: "Carrer de Lleida, 144, El Prat de Llobregat" },
    { id: 44, name: "Floristería el Trébol", category: "llar", lat: 41.3232359, lng: 2.0983807, color: "#2ecc71", description: "Carrer de Lleida, 116, El Prat de Llobregat", address: "Carrer de Lleida, 116, El Prat de Llobregat" },
